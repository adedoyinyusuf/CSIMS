-- Enhanced Cooperative Society Database Schema - Simplified Version
...
CREATE TABLE IF NOT EXISTS contribution_withdrawals (
    ...
    contribution_types TEXT COMMENT 'JSON array of contribution types to withdraw from',
...
-- Insert sample share capital records for existing members
INSERT IGNORE INTO share_capital (member_id, share_type, number_of_shares, par_value, total_value, purchase_date, status)
