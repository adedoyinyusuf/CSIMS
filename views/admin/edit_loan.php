...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="card-title mb-0">Edit Loan Application</h5>
                </div>
                <div class="card-body">
                    <form action="" method="POST" id="loanForm" class="needs-validation" novalidate>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="purpose" name="purpose" rows="2" required><?php echo isset($_POST['purpose']) ? $_POST['purpose'] : $loan['purpose']; ?></textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" id="collateral" name="collateral" rows="2"><?php echo isset($_POST['collateral']) ? $_POST['collateral'] : $loan['collateral']; ?></textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="guarantor" class="form-label">Guarantor (if any)</label>
                                <textarea class="form-control" id="guarantor" name="guarantor" rows="2"><?php echo isset($_POST['guarantor']) ? $_POST['guarantor'] : $loan['guarantor']; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="notes" name="notes" rows="3"><?php echo isset($_POST['notes']) ? $_POST['notes'] : $loan['notes']; ?></textarea>
                            </div>
                        </div>
