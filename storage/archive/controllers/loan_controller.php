...
// Handle AJAX requests ONLY when accessed directly and an 'action' parameter is provided
if (basename($_SERVER['SCRIPT_FILENAME']) === basename(__FILE__) && $_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
