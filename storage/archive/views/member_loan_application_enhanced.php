        ...
        <div class="w-64 bg-gradient-to-br from-primary-600 to-primary-800 shadow-xl">
            <div class="flex flex-col h-full p-6">
                ...
                <nav class="flex-1 space-y-2">
                    ...
                    <a class="flex items-center px-4 py-3 text-primary-200 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-200" href="member_savings.php">
