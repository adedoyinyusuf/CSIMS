...
try {
    $stmt = $pdo->prepare("\n        SELECT \n            COALESCE(SUM(CASE WHEN sa.account_type LIKE 'Mandatory%' THEN st.amount ELSE 0 END), 0) as mandatory_savings,\n            COALESCE(SUM(CASE WHEN sa.account_type LIKE 'Voluntary%' THEN st.amount ELSE 0 END), 0) as voluntary_savings,\n            COALESCE(SUM(st.amount), 0) as total_savings,\n            COUNT(DISTINCT DATE_FORMAT(st.transaction_date, '%Y-%m')) as contribution_months\n        FROM savings_transactions st\n        JOIN savings_accounts sa ON st.account_id = sa.id\n        WHERE st.member_id = ?\n          AND st.transaction_type = 'Deposit'\n          AND st.transaction_status = 'Completed'\n          AND st.transaction_date >= DATE_SUB(NOW(), INTERVAL 12 MONTH)\n    ");
...
try {
    $stmt = $pdo->prepare("\n        (SELECT 'savings_deposit' as type, st.amount, st.transaction_date as created_at, 'Savings deposit' as description\n         FROM savings_transactions st\n         WHERE st.member_id = ?\n           AND st.transaction_type = 'Deposit'\n           AND st.transaction_status = 'Completed'\n         ORDER BY st.transaction_date DESC LIMIT 3)\n        UNION ALL\n        (SELECT 'loan_payment' as type, lr.amount as amount, lr.payment_date as created_at, 'Loan repayment' as description\n         FROM loan_repayments lr\n         JOIN loans l ON lr.loan_id = l.id\n         WHERE l.member_id = ?\n         ORDER BY lr.payment_date DESC LIMIT 3)\n        ORDER BY created_at DESC LIMIT 5\n    ");
                ...
                <div class="container-fluid py-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-3 col-md-6 mb-3">
                            <div class="dashboard-card card card-member stat-card-success">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <div class="dashboard-card card card-member stat-card-info">
                                <div class="card-body text-center">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <div class="dashboard-card card card-member stat-card-warning">
                                <div class="card-body text-center">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <div class="dashboard-card card card-member stat-card-primary">
                                <div class="card-body text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <!-- Pending Workflows -->
                            <?php if (!empty($pendingWorkflows)): ?>
                            <div class="dashboard-card card card-member mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="../member_workflow_tracking.php" class="btn btn-standard btn-outline-primary">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-xl-3 mb-3">
                                            <button class="quick-action-btn btn btn-standard <?= $canApplyForLoan ? 'btn-success' : 'btn-secondary disabled' ?> w-100" 
                                        ...
                                        <div class="col-md-6 col-xl-3 mb-3">
                                            <button class="quick-action-btn btn btn-standard btn-primary w-100" onclick="location.href='member_savings_enhanced.php'">
                                                <i class="fas fa-piggy-bank me-2"></i>
                                                Make Deposit
                                            </button>
                                        </div>
                                        <div class="col-md-6 col-xl-3 mb-3">
                                            <button class="quick-action-btn btn btn-standard btn-info w-100" onclick="location.href='../member_workflow_tracking.php'">
                                                <i class="fas fa-chart-line me-2"></i>
                                                Track Applications
                                            </button>
                                        </div>
                                        <div class="col-md-6 col-xl-3 mb-3">
                                            <button class="quick-action-btn btn btn-standard btn-outline-primary w-100" onclick="location.href='member_loans.php'">
                            ...
                            <div class="dashboard-card card card-member">
                                <div class="card-header bg-transparent">
                                    <h5 class="mb-0">
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($recentActivity as $activity): ?>
                                            <div class="d-flex align-items-center mb-3">
                                                <div class="me-3">
                                                    <i class="fas fa-<?= $activity['type'] === 'savings_deposit' ? 'piggy-bank text-success' : 'money-bill-wave text-primary' ?> fa-sm"></i>
                                                </div>
                                                <div class="flex-grow-1">
